...
export default function BlogLargecard() {
  ...
  useEffect(() => {
    ...
    tl.to(arrowRef.current, { duration: 0.7, display: "none" });
    tl.to(arrowRef2.current, { duration: 0.7, display: "block" });
    tl.to(arrowRef2.current, { duration: 0.7, display: "none" });
    tl.to(arrowRef.current, { duration: 0.7, display: "block" });
